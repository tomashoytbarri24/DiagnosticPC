...
checks = {
    ...
    'sidebar_icons_are_assets': 'SIDEBAR_ICON_FILES' in dashboard and "'btn_health_center': 'health.png'" in dashboard,
    'gaming_not_published_in_sidebar': "'btn_overlay': 'Gaming'" not in sidebar and "app.btn_overlay.pack(" not in dashboard,
