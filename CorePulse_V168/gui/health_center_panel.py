    ...
    def _run_visual_benchmark(self):
        ...
        def work():
            ...
            if gpu_selected:
                ...
                if classic_selected:
                    next_labels = {'cpu': 'CPU', 'ram': 'RAM', 'ssd': 'SSD'}
                    remaining = ' → '.join(next_labels[k] for k in classic_selected)
                    push_progress(gpu_span, 'GPU 3D completada', f'La ventana 3D terminó correctamente. Continúa: {remaining}')
