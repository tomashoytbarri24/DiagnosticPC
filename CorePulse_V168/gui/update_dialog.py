...
class UpdatePanel:
    ...
    def _build(self):
        ...
        ctk.CTkButton(actions, text="Releases", width=100, height=36, fg_color="transparent", hover_color=_c("surface_2"), border_width=1, border_color=_c("border"), text_color=_c("text_2"), command=lambda: webbrowser.open(releases_web_url())).grid(row=0, column=2, sticky="w", padx=(8, 0))
