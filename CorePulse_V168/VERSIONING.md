...
V167 automatiza la prerelease del canal Desarrollo en GitHub Actions. El push de cualquier rama `*/corepulse-dev` genera/actualiza el ZIP fuente verificado de la versión actual sin crear una release por commit.
