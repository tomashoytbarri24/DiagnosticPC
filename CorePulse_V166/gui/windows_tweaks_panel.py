...
class WindowsTweaksPanel:
    ...
    def _build(self):
        ...
        ctk.CTkButton(
            ...
            hover_color=theme_color('#102840'), border_width=1, border_color=theme_color('#214765'), text_color=TEXT_2,
        ...
        def run():
            ...
            try:
                if host is not None and host.is_scrolling():
                    host.defer_until_idle(lambda: self._apply_filters(preserve_scroll=True), key='tweaks-filter')
                    return
            except Exception:
                pass
