...
def analyze_drivers(limit: int = 400) -> Dict[str, Any]:
    ...
    return {
        ...
        'note': 'Antigüedad no implica por sí sola un problema ni confirma que exista una actualización disponible. La vista prioriza GPU, red, audio, almacenamiento, chipset/plataforma, Bluetooth y USB.',
    }
