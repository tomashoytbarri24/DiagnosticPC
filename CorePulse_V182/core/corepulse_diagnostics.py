...
def collect_corepulse_diagnostics(
    ...
    *,
    ...
    # PowerShell pertenece a Reparación de Windows y no se publica como
    # capacidad en otros sistemas operativos.
    if os.name == "nt":
    ...
    report: Dict[str, Any] = {
        ...
        "note": "Las capacidades propias de otro sistema operativo se omiten; las compatibles se informan sólo con evidencia real.",
    }
