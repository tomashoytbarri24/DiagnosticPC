...
def test_legacy_checks():
    ...
    hybrid_idle_gpus = [
        {'name': 'Display Fabric APU', 'usage_percent': 9.0, 'temperature_c': 44.0, 'memory_total_mb': None},
        {'name': 'Render Accelerator Z16', 'usage_percent': 0.0, 'temperature_c': 41.0, 'memory_total_mb': 8192.0, 'power_w': 18.0, 'fan_rpm': 1200.0},
    ]
    selected_hybrid_idle = select_active_gpu(hybrid_idle_gpus)
    ...
    results = [
        ...
        check('hybrid_idle_prefers_high_capability_gpu', selected_hybrid_idle.get('name') == 'Render Accelerator Z16'),
    ]
