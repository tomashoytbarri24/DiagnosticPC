"""Regresión de V100: Red avanzada debe sobrevivir al rebuild del sidebar."""
...
def main():
    ...
    checks=[
        ...
        check('dashboard_rebuild_packs_network', "_apply_sidebar_icon(app, 'btn_network')" in dashboard and "app.btn_network.pack(fill='x', padx=11, pady=1)" in dashboard),
