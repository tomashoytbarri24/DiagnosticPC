...
class MethodologyTests(unittest.TestCase):
    def test_version_and_method_ids(self):
        # La metodología V162 debe sobrevivir a versiones posteriores de la app.
        self.assertGreaterEqual(int(VERSION), 162)
    ...
    def test_suite_gpu_uses_visual_multiphase_contract(self):
        ...
        with patch.object(benchmark_engine.platform, 'system', return_value='Windows'), \
...
class CompleteDiagnosticV162Tests(unittest.TestCase):
    ...
    def test_complete_diagnostic_uses_visual_gpu_and_finishes(self):
        ...
        with patch.object(diag.platform, 'system', return_value='Windows'), \
             patch.object(benchmark_engine, 'benchmark_cpu', side_effect=generic('cpu')), \
