...
class GamingPanel:
    ...
    def _ensure_tab(self, key):
        ...
        if key == 'overlay':
            ...
            panel = HealthCenterPanel(
                ...
                initial_performance_section=self._pending_performance_section,
            )
    ...
    def select_tab(self, key):
        ...
        if key == self._tab and self._child_panel is not None:
            ...
            return
        self._tab = key
        if key == 'performance' and self._pending_performance_section not in ('home', 'library', 'stability', 'boost'):
            self._pending_performance_section = 'home'
        self._apply_view_style()
