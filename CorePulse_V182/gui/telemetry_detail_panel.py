...
class TelemetryDetailPanel:
    ...
    def _build(self):
        ...
        ctk.CTkButton(
            ...
            fg_color='transparent', hover_color=theme_color('#102840'), border_width=1, border_color=theme_color('#214765'), text_color=TEXT_2,
        ...
        hero = build_title_block(
            titles,
            eyebrow='Evidencia certificada',
            title='Trazabilidad de telemetría',
            subtitle='Comprueba el valor real, su fuente, sensor, calidad y antigüedad antes de usarlo en un diagnóstico.',
            accent=CYAN,
            badges=(('Fuente', CYAN), ('Sensor', GREEN), ('Calidad', AMBER)),
            title_size=19,
        )
