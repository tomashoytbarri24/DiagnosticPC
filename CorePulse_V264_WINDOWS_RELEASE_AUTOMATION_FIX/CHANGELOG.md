...
## V264 — Release Automation Fix

- Corregida la selección de versiones con nombres largos en GitHub Actions.
- Development Release detecta la versión modificada por el push.
- Stable Release preparado para `main`.
- Validación carpeta ↔ `core/version.py`.
- ZIP + SHA-256 compatibles con el actualizador.
- Actions legacy detectadas y señaladas desde el publicador.
- Actions V7 y runner `ubuntu-24.04`.
