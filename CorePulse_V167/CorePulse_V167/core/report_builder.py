...
def _complete_diagnostic_flowables(diag: Dict[str, Any], st):
    ...
    out = [_section('3.1 Diagnóstico Completo: benchmark y telemetría', st), Spacer(1, 1.5 * mm), _table(rows, [31 * mm, 146 * mm], st, font_scale='small'), Spacer(1, 1.8 * mm)]
    ...
    out += [Paragraph('El benchmark mide rendimiento y permite observar temperaturas, uso y frecuencias durante esa misma carga. Esta observación no certifica estabilidad prolongada. Ninguna reparación se ejecuta automáticamente durante el diagnóstico.', st['small'])]
    return out
