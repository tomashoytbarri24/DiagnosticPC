"""Regresión de V100 — biblioteca extendida de Tweaks Windows 11."""
...
def main():
    ...
    results=[
        ...
        check('admin_partition', 'requires_admin' in panel and 'Windows mostrará UAC sólo para los tweaks' in panel),
