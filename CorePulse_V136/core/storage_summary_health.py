...
def collect_storage_summary_health(telemetry: Dict[str, Any]) -> Dict[int, Dict[str, Any]]:
    ...
    for index, device in enumerate(devices):
        ...
        # Autoridad: el SMART/Health Log NVMe directo gana a cualquier valor
        ...
        if nvme_remaining is not None:
            ...
            # Wear=0 es ambiguo en algunos controladores (puede ser no soportado).
            # Sólo un desgaste positivo se usa como fallback cuantitativo.
        ...
        out[index] = {
            ...
            'wear_quantitative_reliable': bool(nvme_used is not None or (windows_wear is not None and windows_wear > 0.0)),
            'temperature_c': temp,
