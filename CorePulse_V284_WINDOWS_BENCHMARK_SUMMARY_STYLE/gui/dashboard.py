...
def _build_header(app):
    ...
    # V283: la tarjeta del agente sigue la firma visual del Resumen,
    # sin texto gris redundante y con geometría equivalente a las demás tarjetas.
    right = ctk.CTkFrame(hero, fg_color='transparent', width=364)
    right.pack(side='right', fill='y', padx=(8, 4), pady=(0, 0))
    ...
    agent_accent = ctk.CTkFrame(shell, fg_color=COLORS['primary'], width=4, corner_radius=12)
    agent_accent.pack(side='left', fill='y', padx=(1, 0), pady=1)
    ...
    text_box = ctk.CTkFrame(title_row, fg_color='transparent')
    ...
    substate = ctk.CTkLabel(
        text_box,
        text='Cobertura de monitoreo activa',
        font=(FONT, 8, 'bold'),
        text_color=COLORS['text_2'],
        anchor='w',
    )
    substate.pack(anchor='w', pady=(2, 0))
    ...
    detail = ctk.CTkLabel(
        body,
        text='Supervisión unificada del sistema en tiempo real.',
        font=(FONT, 8),
        text_color=COLORS['text_2'],
        anchor='w',
        justify='left',
    ...
    dot = ctk.CTkLabel(footer, text='●', width=12, height=16, font=(FONT, 10, 'bold'), text_color=COLORS['green'])
    dot.pack(side='left', padx=(0, 4))
    mode = ctk.CTkLabel(footer, text='Escritorio', height=16, font=(FONT, 8, 'bold'), text_color=COLORS['muted'], anchor='w')
    mode.pack(side='left')
    ...
    app._header_last_update.pack(side='right')
    ...
    app._agent_dot = dot
    app._agent_status = hidden_status
    app._agent_mode = mode
    app._agent_state = state_label
    app._agent_substate = substate
