...
V280 mantiene exclusivamente temas oscuros y unifica superficies para evitar fondos claros/aislados entre módulos. La preferencia se persiste y se aplica al reiniciar únicamente la
