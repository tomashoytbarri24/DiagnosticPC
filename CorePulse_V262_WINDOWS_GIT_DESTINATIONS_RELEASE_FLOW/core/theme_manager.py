...
V258 integra la galería de 20 temas recuperada de la línea V223/V225 y una autoridad visual única. La preferencia se persiste y se aplica al reiniciar únicamente la
...
_THEME_PROFILES = {
    ...
    'frost': {
        'name': 'Hielo', 'description': 'Claro azulado, limpio y técnico', 'appearance': 'light',
        'bg': '#e9f1f6', 'surface': '#f8fbfd', 'surface_2': '#dce9f0',
        'sidebar': '#eef5f9', 'border': '#afc4d0', 'text': '#19303d',
        'text_2': '#405d6d', 'muted': '#708795', 'accent': '#2b8fb8', 'accent_2': '#64acc9',
    },
    'sakura': {
        'name': 'Sakura', 'description': 'Rosa claro suave y profesional', 'appearance': 'light',
        'bg': '#f3e9ed', 'surface': '#fcf7f9', 'surface_2': '#eadde3',
        'sidebar': '#f7eef2', 'border': '#d2b7c3', 'text': '#3b2730',
        'text_2': '#624652', 'muted': '#8c6e7b', 'accent': '#b9577d', 'accent_2': '#d487a5',
    },
}
...
def get_theme_profiles():
    """Devuelve una copia liviana de las 20 paletas disponibles."""
