...
class ProfessionalCleaningCenterPanel(CleaningCenterPanel):
    ...
    def _build_header(self):
        ...
        ctk.CTkButton(right, text='Volver al monitoreo', width=145, height=32, corner_radius=8, fg_color=theme_color('#17263a'), hover_color=theme_color(theme_color('#203650')), border_width=1, border_color=theme_color('#29435f'), text_color=TEXT, font=('Segoe UI', 9, 'bold'), command=self.close).pack(side='left')
    ...
    def _build_cards(self):
        ...
        for label in ('Confirmación', 'Medición real', 'Acciones separadas'):
            ctk.CTkLabel(self.badges, text=label, font=('Segoe UI', 8, 'bold'), text_color=theme_color('#bcd0e2'), fg_color=theme_color(theme_color('#163047')), corner_radius=6, padx=6, pady=2).pack(side='left', padx=2)
