...
class App(ctk.CTk):
    ...
    def _commit_sidebar_drawer_state(self, collapsed, target_width):
        ...
        def release_final_frame():
            ...
            try:
                self.after(8, self._finish_sidebar_chart_reflow)
            except Exception:
    ...
    def _run_sidebar_drawer(self, collapsed, target_width, duration_ms=72):
        ...
        conserva el ancho actual del contenido durante los ~72 ms del gesto y
    ...
    def set_sidebar_collapsed(self, collapsed, *, animated=True):
        ...
        try:
            self._clear_sidebar_transition_cover()
        except Exception:
            pass
        try:
            self._clear_sidebar_motion_layers()
        except Exception:
            pass
        try:
        ...
        if not animated:
            self._commit_sidebar_drawer_state(collapsed, target_width)
            return
        self._run_sidebar_drawer(collapsed, target_width, duration_ms=72)
