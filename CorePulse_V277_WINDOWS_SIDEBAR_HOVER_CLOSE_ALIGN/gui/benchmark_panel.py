...
class BenchmarkPanel:
    ...
    def __init__(self, app, host):
        ...
        back = ctk.CTkButton(
            ...
            width=178, height=BENCH_CONTROL_H, corner_radius=BENCH_RADIUS, fg_color='transparent',
        ...
        titles.pack(side='left', fill='x', expand=True, padx=(16, 14))
        ...
        self._content.pack(fill='both', expand=True, padx=18, pady=(0, 12))
