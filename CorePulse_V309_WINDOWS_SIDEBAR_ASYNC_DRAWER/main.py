...
class App(ctk.CTk):
    ...
    def _commit_sidebar_drawer_state(self, collapsed, target_width):
        """Commit único del ancho del dashboard al terminar el deslizamiento.

        Durante el slide NO cambia la columna 0. Sólo aquí se modifica el grid,
        con WM_SETREDRAW durante el mínimo tiempo posible. No se invoca el
        relayout responsivo completo porque el tamaño de la ventana no cambió.
        """
        ...
        try:
            ...
            # Sólo resuelve la geometría Tk necesaria para este commit. El
            # responsive completo y Matplotlib permanecen fuera del gesto.
        ...
        # Un pequeño debounce impide que el canvas pelee con el frame de commit.
        try:
            self.after(24, self._finish_sidebar_chart_reflow)
        except Exception:
    ...
    def _run_sidebar_drawer(self, collapsed, target_width, duration_ms=96):
        ...
        conserva el ancho actual del contenido durante los ~96 ms del gesto y
    ...
    def set_sidebar_collapsed(self, collapsed, *, animated=True):
        ...
        if not animated:
            self._commit_sidebar_drawer_state(collapsed, target_width)
            return
        self._run_sidebar_drawer(collapsed, target_width, duration_ms=96)
