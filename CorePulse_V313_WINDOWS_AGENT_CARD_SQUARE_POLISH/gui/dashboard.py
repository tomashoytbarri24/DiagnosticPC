...
def _build_header(app):
    ...
    state_label = ctk.CTkLabel(status_col, text='Evaluando evidencia', height=16, font=(FONT, 8, 'bold'), text_color=COLORS['primary'], anchor='w')
    state_label.pack(anchor='w')

    detail = ctk.CTkLabel(
        status_col, text='Acumulando evidencia del sistema…', height=14,
    ...
    app._header_last_update = ctk.CTkLabel(
        meta_col, text='Actualizado: esperando', height=15, font=(FONT, 7),
