"""Prueba manual del Benchmark GPU V13 DirectX 11.

V13 corrige la ralentización aparente: cámara, agua, viento y duración usan
reloj de pared; FPS/1% Low siguen midiendo sólo render + Present.
"""
...
from core.benchmark_engine import save_last_gpu_v13_result
...
def main() -> int:
    print("CorePulse Benchmark V13 · DirectX 11 · wall-clock deterministic", flush=True)
    ...
    if str(result.get("status") or "").upper() == "OK":
        out = save_last_gpu_v13_result(result)
    print("\nResumen:")
