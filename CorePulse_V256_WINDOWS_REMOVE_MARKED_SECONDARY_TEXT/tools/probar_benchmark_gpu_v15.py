"""Prueba manual del Benchmark GPU V15 DirectX 11.

V15 corrige la ralentización aparente: cámara, agua, viento y duración usan
...
from core.benchmark_engine import save_last_gpu_v15_result
...
def main() -> int:
    print("CorePulse Benchmark V15 · DirectX 11 · wall-clock deterministic", flush=True)
    ...
    if str(result.get("status") or "").upper() == "OK":
        out = save_last_gpu_v15_result(result)
    print("\nResumen:")
