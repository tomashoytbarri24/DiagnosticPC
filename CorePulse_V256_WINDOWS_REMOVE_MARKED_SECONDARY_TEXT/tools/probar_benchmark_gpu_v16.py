"""Prueba manual del Benchmark GPU V16 DirectX 11.

V16 corrige la ralentización aparente: cámara, agua, viento y duración usan
...
from core.benchmark_engine import save_last_gpu_v16_result
...
def main() -> int:
    print("CorePulse Benchmark V16 · DirectX 11 · wall-clock deterministic", flush=True)
    ...
    if str(result.get("status") or "").upper() == "OK":
        out = save_last_gpu_v16_result(result)
    print("\nResumen:")
