...
class CleaningCenterPanel(ctk.CTkFrame):
    ...
    def optimize_ram_deep(self):
        ...
        self._thread(lambda: optimize_ram_deep(settle_seconds=1.15, snapshot_samples=5, purge_standby=True), self._ram_deep_done, self._ram_fail)
    ...
    def clean_storage(self):
        ...
        self._thread(lambda: delete_scanned_candidates(result), self._storage_clean_done, self._storage_scan_fail)
