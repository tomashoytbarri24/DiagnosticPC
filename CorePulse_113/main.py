...
from core.theme_manager import color as theme_color, get_ctk_appearance_mode, brand_symbol_path, theme_action_label
# Código refactorizado: nombres estables y documentación en español.
from pathlib import Path
from core.runtime_logging import configure_runtime_logging, get_logger, install_exception_hooks
from core.runtime_paths import resource_root, data_path
...
class App(ctk.CTk):
    ...
    def _build_fast_disk_snapshot(self, telemetry):
        ...
        for idx, device in enumerate(devices):
            try:
                ...
                if temp is None:
                    temp = enrichment.get('temperature_c')
                result.append({
                    'index': idx,
                    'model': str(model),
    ...
    def on_close(self):
        ...
        for attr in ('resize_timer', 'telemetry_after_id', 'chart_after_id', 'diagnostic_after_id', 'agent_after_id', '_battery_health_refresh_after_id'):
